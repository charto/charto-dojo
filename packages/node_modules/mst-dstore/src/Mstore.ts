...
export const MstoreClass = declare([ Store, Promised, SimpleQuery ], {
...
export function instanceType<T>(arg: dojo._base.DeclareConstructor<T>) { return(null as any as T); }
export const mstoreInstance = instanceType(Mstore);
export type Mstore = typeof mstoreInstance;
